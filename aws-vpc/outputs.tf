...
output "container_subnet_objects" {
  description = "A list of all container subnets, containing the full objects."
  value       = aws_subnet.container
}
...
output "container_subnet_arns" {
  description = "List of ARNs of container subnets"
  value       = aws_subnet.container[*].arn
}

output "container_subnets_cidr_blocks" {
  description = "List of cidr_blocks of container subnets"
  value       = compact(aws_subnet.container[*].cidr_block)
}

output "container_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of container subnets in an IPv6 enabled VPC"
  value       = compact(aws_subnet.container[*].ipv6_cidr_block)
}

output "container_subnet_group" {
  description = "ID of container subnet group"
  value       = try(aws_db_subnet_group.container[0].id, null)
}

output "container_subnet_group_name" {
  description = "Name of container subnet group"
  value       = try(aws_db_subnet_group.container[0].name, null)
}

output "container_route_table_ids" {
  description = "List of IDs of container route tables"
  # Refer to https://github.com/terraform-aws-modules/terraform-aws-vpc/pull/926 before changing logic
  value = length(aws_route_table.container[*].id) > 0 ? aws_route_table.container[*].id : aws_route_table.private[*].id
}

output "container_internet_gateway_route_id" {
  description = "ID of the container internet gateway route"
  value       = try(aws_route.container_internet_gateway[0].id, null)
}

output "container_nat_gateway_route_ids" {
  description = "List of IDs of the container nat gateway route"
  value       = aws_route.container_nat_gateway[*].id
}

output "container_ipv6_egress_route_id" {
  description = "ID of the container IPv6 egress route"
  value       = try(aws_route.container_ipv6_egress[0].id, null)
}

output "container_route_table_association_ids" {
  description = "List of IDs of the container route table association"
  value       = aws_route_table_association.container[*].id
}

output "container_network_acl_id" {
  description = "ID of the container network ACL"
  value       = try(aws_network_acl.container[0].id, null)
}

output "container_network_acl_arn" {
  description = "ARN of the container network ACL"
  value       = try(aws_network_acl.container[0].arn, null)
}
